...
import { setAuthInitialized, setLoading, setUser } from '@/redux/authSlice'
...
const Login = () => {
    ...
    const { loading, user, initialized } = useSelector(store => store.auth);
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                ...
                const dashboard = res.data.user.role === 'admin' ? '/admin/dashboard' : res.data.user.role === 'employer' ? '/employer/dashboard' : '/candidate/dashboard';
